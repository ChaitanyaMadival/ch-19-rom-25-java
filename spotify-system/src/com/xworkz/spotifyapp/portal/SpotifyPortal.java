package com.xworkz.spotifyapp.portal;

import com.xworkz.spotifyapp.SpotifyUser;

public class SpotifyPortal {
    SpotifyUser user;

    public  boolean createFacebookUser(SpotifyUser user){
    ...
    public  void  fetchUserInfo(){
        ...
        System.out.println("Date of birth gender : "+user.getGender());
